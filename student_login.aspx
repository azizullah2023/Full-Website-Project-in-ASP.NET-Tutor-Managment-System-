<%@ Page Title="" Language="C#" MasterPageFile="~/FWP_Site1.Master" AutoEventWireup="true" CodeBehind="student_login.aspx.cs" Inherits="FUll_Website_Project.student_login" %>
     ...
     <div class="row" >
         <div class="col-md-5 mx-auto" style="box-shadow: -2px 2px 29px 1px rgb(0, 0, 0,0.4);" >
            <br /> 
             ...
             <br /> <br /> 
             <asp:Button ID="loginadminbtn" Onclick="loginadminbtn_Click"  Class="btn btn-block btn-primary btn-hover" runat="server" Text="Login" />
             <div  class="text-center" >
    <a href="tutor_login.aspx" class="text-primary " >Login AS Tutor</a>
</div>
             <br />
         </div>
